...
class JiangXiCompass(BaseCompass):
    ...
    start_urls = [
        ...
        ("http://59.52.254.106:8893/outQueryEnterpriseAll"),
        ("http://59.52.254.108:8093/acsOutNetQueryPageList"),
        ("http://59.52.254.106:8893/outQueryBusinessList"),
        ("http://59.52.254.106:8093/qualificationCertificateListForPublic"),
        ("http://59.52.254.78/jxjsw/webSite/appInfo/entcredit.aspx")
    ]
